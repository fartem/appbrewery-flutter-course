...
class StoryBrain {
  ...
  String getFirstChoice() {
    return getStory().firstChoice;
  }

  String getSecondChoice() {
    return getStory().secondChoice;
  }

  void nextStory(int answer) {
    switch (_storyNumber) {
      case 0:
        _storyNumber = answer == 1 ? 2 : 1;
        break;
      case 1:
        _storyNumber = answer == 1 ? 2 : 3;
        break;
      case 2:
        _storyNumber = answer == 1 ? 5 : 4;
        break;
      default:
        restart();
        break;
